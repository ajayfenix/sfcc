...
.fenix-logo svg{position:relative;top:0px;}
...
.fenix-provided-options th{background-color:#8ad1f1!important;color:#ffffff!important;}

.fixd-delivery #change-zip-container a.btn{height:40px;color:#fff !important;font-weight:600;line-height:30px;text-decoration:none;text-transform:uppercase;display:inline-block;padding:5px;vertical-align:top;width:150px;outline:none;text-align:center;font-size:14px;}
.fixd-delivery #change-zip-container a.btn{background-color:#000000!important;}

.fixd-delivery #change-zip-container input{width:30%;margin-left:0!important;margin-top:0!important;font-size:15px;height:40px;padding-left:10px;display:inline-block;font-weight:normal;}
